              ...
              <div id="collapse<?php echo $section['id']; ?>" class="lecture-list collapse <?php if($counter == 0) echo 'show'; ?>">
                <ul>
                  ...
                  <li class="lecture has-preview">
                    ...
                    <!-- <span class="lecture-preview float-right" data-toggle="modal" data-target="#ReviewersPreviewModal">Preview</span> -->
                  </li>
                <?php endforeach; ?>
              </ul>
            </div>
  ...
  <div class="course-sidebar natural">
    <?php if ($course_details['video_url'] != ""): ?>
      <div class="preview-video-box">
        <a data-toggle="modal" data-target="#ReviewersPreviewModal">
...
<?php if ($course_details['video_url'] != ""):
  ...
  ?>
  <div class="modal fade" id="ReviewersPreviewModal" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
