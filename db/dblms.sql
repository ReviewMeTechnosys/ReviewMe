...
(2, 'banner_sub_title', 'Study any topic, anytime. Explore reviewers, learn more.'),
(4, 'about_us', '<p></p><h2>This is about us</h2><p><span xss=\"removed\" xss=removed>Welcome to ReviewMe. Let us review for a brighter future</span></p>'),
(10, 'terms_and_condition', '<h2>Terms and Condition</h2>This is the Terms and condition page'),
(11, 'privacy_policy', '<h2>Privacy Policy</h2>This is the Privacy Policy page '),
(13, 'theme', 'default');
...
(401, 'number_of_active_reviewers', NULL, NULL),
(402, 'number_of_pending_courses', NULL, NULL),
(403, 'all_instructor', NULL, NULL),
(404, 'active_reviewers', NULL, NULL),
...
(1, 'language', 'english'),
(2, 'system_name', 'ReviewMe'),
(3, 'system_title', 'ReviewMe'),
