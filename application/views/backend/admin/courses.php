<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('reviewers'); ?>
                    <a href="<?php echo site_url('admin/course_form/add_course'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_reviewer'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                        ...
                        <a href="<?php echo site_url('admin/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('active_reviewer'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo site_url('admin/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('pending_reviewers'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo site_url('admin/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('free_reviewers'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="<?php echo site_url('admin/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('paid_reviewers'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
