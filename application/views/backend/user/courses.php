                        ...
                        <a href="<?php echo site_url('user/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>
                                        <?php
                                            $active_reviewers = $this->crud_model->get_status_wise_courses_for_instructor('active');
                                            echo $active_reviewers->num_rows();
                                         ?>
                                    </span></h3>
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('active_reviewers'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
