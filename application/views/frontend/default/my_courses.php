...
<section class="page-header-area my-course-area">
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="page-title"><?php echo get_phrase('my_reviewers'); ?></h1>
                <ul>
                  <li class="active"><a href="<?php echo site_url('home/my_courses'); ?>"><?php echo get_phrase('all_reviewers'); ?></a></li>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <?php foreach ($categories as $category):
                                ...
                                ?>
                                <a class="dropdown-item" href="#" id = "<?php echo $category; ?>" onclick="getReviewersByCategoryId(this.id)"><?php echo $category_details['name']; ?></a>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    <!-- <div class="btn-group">
                ...
                <div class="my-course-search-bar">
                    <form action="">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="<?php echo get_phrase('search_my_reviewers'); ?>" onkeyup="getReviewersBySearchString(this.value)">
                    ...
                    <div class="course-box-wrap">
                            <div class="course-box">
                                ...
                                <div class="course-details">
                                    ...
                                    <div class="rating your-rating-box" onclick="event.preventDefault();" data-toggle="modal" data-target="#EditRatingModal">
                                        ...
                                        <?php else: ?>
                                         ...
                                         <?php endif; ?>
                                        <?php endfor; ?>
                                        <p class="your-rating-text" id = "<?php echo $my_course['course_id']; ?>" onclick="getReviewersDetailsForRatingModal(this.id)">
                                ...
                                <div class="row" style="padding: 5px;">
                                    <div class="col-md-6">
                                        <a href="<?php echo site_url('home/course/'.slugify($course_details['title']).'/'.$my_course['course_id']); ?>" class="btn"><?php echo get_phrase('reviewer_detail'); ?></a>
                                    </div>
                                    <div class="col-md-6">
...
function getReviewersByCategoryId(category_id) {
    $.ajax({
        type : 'POST',
...
function getReviewersBySearchString(search_string) {
    $.ajax({
        type : 'POST',
...
function getReviewersDetailsForRatingModal(course_id) {
    $.ajax({
        type : 'POST',
