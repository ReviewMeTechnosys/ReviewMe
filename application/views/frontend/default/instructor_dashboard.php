    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <ul>
                    <li class="<?php if($type == 'active') echo "active"; ?>"><a href="<?php echo site_url('home/dashboard/active'); ?>"><?php echo get_phrase('active_reviewers'); ?> ( <?php echo $my_courses['active']->num_rows(); ?> )</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col" style="padding: 35px;">
                <?php if ($type == 'active'): ?>
                    <?php include 'active_reviewers.php'; ?>
