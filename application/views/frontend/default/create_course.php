...
<!--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="checkbox check-success">
                                <input id="isTopReviewersCheckbox" type="checkbox" value="1" name = "is_top_course" onclick="topReviewersChecked(this)">
                    ...
                    <div class="basic-group">
                        ...
                        <div class="row-fluid">
                            <div class="checkbox check-success">
                                <input id="freeReviewersCheckbox" type="checkbox" value="1" name = "is_free_course" onclick="isFreeReviewersChecked()">
