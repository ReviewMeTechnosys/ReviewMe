            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        ...
                        echo $number_of_courses.' '.get_phrase('online_reviewers'); ?></h4>
...
<section class="course-carousel-area">
    <div class="container-lg">
        <div class="row">
            <div class="col">
                <h2 class="course-carousel-title"><?php echo get_phrase('top_reviewers'); ?></h2>
...
<section class="course-carousel-area">
    <div class="container-lg">
        <div class="row">
            <div class="col">
                <h2 class="course-carousel-title"><?php echo get_phrase('top').' 10 '.get_phrase('latest_reviewers'); ?></h2>
                <div class="course-carousel">
                    <?php
