    ...
    <div class="content-box">
        <div class="basic-group">
            <form action="<?php echo site_url('home/course_action/edit/'.$course_id); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="checkbox check-success">
                        <input id="isTopReviewersCheckbox" type="checkbox" value="1" name = "is_top_course" onclick="topReviewersChecked(this)" <?php if($course_details['is_top_course'] == 1) echo 'checked'; ?>>
                        <label for="isTopReviewersCheckbox" onclick="topReviewersChecked(this)"><?php echo get_phrase('is_top_course'); ?></label>
                    </div>
                </div>
            ...
            <div class="basic-group">
                <div class="row-fluid">
                    <div class="checkbox check-success">
                        <input id="freeReviewersCheckbox" type="checkbox" value="1" name = "is_free_course" onclick="isFreeReviewersChecked()" <?php if($course_details['is_free_course'] == 1) echo 'checked'; ?>>
                        <label for="freeReviewersCheckbox" onclick="isFreeReviewersChecked()"><?php echo get_phrase('free_course'); ?></label>
                    </div>
                </div>
...
function topReviewersChecked(elem){
    if (jQuery('#isTopReviewersCheckbox').is(':checked')) {

        jQuery('#isTopReviewersCheckbox').prop( "checked", false );
    }else {

        jQuery('#isTopReviewersCheckbox').prop( "checked", true );
    }
}
...
function isFreeReviewersChecked() {

    if (jQuery('#freeReviewersCheckbox').is(':checked')) {
